...
class TestDownloadWorker:
    ...
    def test_run(self, mocker: MockerFixture) -> None:
        ...
        mock_add_download = mocker.patch("video_vault.core.downloads.add_download")
    ...
    def test_show_notification(self, mocker: MockerFixture) -> None:
        ...
        mock_notification = mocker.patch("video_vault.core.downloads.Notification")
    ...
    def test_update_downloads_page(self, mocker: MockerFixture) -> None:
        ...
        mock_downloads_page = mocker.patch("video_vault.ui.pages.downloads.Downloads")

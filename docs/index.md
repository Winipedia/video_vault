...
- [User Guide](user-guide.md) - Learn how to use Video Vault
...
- **Embedded Browser**: Navigate to any video site directly in the app
...
1. Check the [User Guide](user-guide.md) for common tasks
2. Review the [Development Guide](development.md) if you're contributing

...
from winipedia_pyside.utils.ui.widgets.notification import Notification
from winipedia_utils.utils.logging.logger import get_logger
from yt_dlp.utils import DownloadError

from video_vault.app.core.ffmpeg import get_ffmpeg_path
from video_vault.app.db.models import File
...
class DownloadWorker(QThread):
    ...
    def update_downloads_page(self) -> None:
        ...
        from video_vault.app.ui.pages.downloads import (  # noqa: PLC0415
